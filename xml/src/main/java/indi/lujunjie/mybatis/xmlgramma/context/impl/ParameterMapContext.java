 ...
 */
public class ParameterMapContext extends ContentContext {

    private static final String PARAMETER_MAP = "parametermap";

    public ParameterMapContext() {
        super(PARAMETER_MAP);
    }

    public <T extends Removable> T accept(AbstractDFSVisitor<T> visitor) {
        return (visitor instanceof BaseVisitor) ? ((BaseVisitor<T>) visitor).visitParameterMap(this) : visitor.visitChildren(this);
    }
}
