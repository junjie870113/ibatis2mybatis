 ...
 */
public class InsertContext extends ContentContext {
    ...
    public <T extends Removable> T accept(AbstractDFSVisitor<T> visitor) {
        return (visitor instanceof BaseVisitor) ? ((BaseVisitor<T>) visitor).visitInsert(this) : visitor.visitChildren(this);
    }
}
