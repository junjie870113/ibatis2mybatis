 ...
 */
public class IsNullContext extends ContentContext {

    private static final String IS_NULL = "isNull";

    public IsNullContext() {
        super(IS_NULL);
    }

    public <T extends Removable> T accept(AbstractDFSVisitor<T> visitor) {
        return (visitor instanceof BaseVisitor) ? ((BaseVisitor<T>) visitor).visitIsNull(this) : visitor.visitChildren(this);
    }
}
