 ...
 */
public class IsNotNullContext extends ContentContext {

    private static final String IS_NOT_NULL = "isNotNull";

    public IsNotNullContext() {
        super(IS_NOT_NULL);
    }

    public <T extends Removable> T accept(AbstractDFSVisitor<T> visitor) {
        return (visitor instanceof BaseVisitor) ? ((BaseVisitor<T>) visitor).visitIsNotNull(this) : visitor.visitChildren(this);
    }
}
