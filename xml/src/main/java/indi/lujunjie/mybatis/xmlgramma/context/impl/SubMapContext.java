 ...
 */
public class SubMapContext extends ContentContext {

    private static final String SUBMAP = "submap";

    public SubMapContext() {
        super(SUBMAP);
    }

    public <T extends Removable> T accept(AbstractDFSVisitor<T> visitor) {
        return (visitor instanceof BaseVisitor) ? ((BaseVisitor<T>) visitor).visitSubMap(this) : visitor.visitChildren(this);
    }
}
