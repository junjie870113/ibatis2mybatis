 ...
 */
public class IsEqualContext extends ContentContext {

    private static final String IS_EQUAL = "isEqual";

    public IsEqualContext() {
        super(IS_EQUAL);
    }

    public <T extends Removable> T accept(AbstractDFSVisitor<T> visitor) {
        return (visitor instanceof BaseVisitor) ? ((BaseVisitor<T>) visitor).visitIsEqual(this) : visitor.visitChildren(this);
    }
}
