 ...
 */
public class CacheModelContext extends ContentContext {

    private static final String CACHE_MODEL = "cachemodel";

    public CacheModelContext() {
        super(CACHE_MODEL);
    }

    public <T extends Removable> T accept(AbstractDFSVisitor<T> visitor) {
        return (visitor instanceof BaseVisitor) ? ((BaseVisitor<T>) visitor).visitCacheModel(this) : visitor.visitChildren(this);
    }
}
