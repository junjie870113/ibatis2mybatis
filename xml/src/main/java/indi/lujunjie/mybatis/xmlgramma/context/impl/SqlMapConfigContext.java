 ...
 */
public class SqlMapConfigContext extends ContentContext {

    public static final String NAME = "sqlmapconfig";

    public SqlMapConfigContext() {
        super(NAME);
    }

    public <T extends Removable> T accept(AbstractDFSVisitor<T> visitor) {
        return (visitor instanceof BaseVisitor) ? ((BaseVisitor<T>) visitor).visitSqlMapConfig(this) : visitor.visitChildren(this);
    }
}
