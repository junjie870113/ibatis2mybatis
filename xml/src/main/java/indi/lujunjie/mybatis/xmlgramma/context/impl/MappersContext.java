 ...
 */
public class MappersContext extends ContentContext {

    private static final String NAME = "mappers";
    ...
    public <T extends Removable> T accept(AbstractDFSVisitor<T> visitor) {
        return (visitor instanceof BaseVisitor) ? ((BaseVisitor<T>) visitor).visitMappers(this) : visitor.visitChildren(this);
    }
}
